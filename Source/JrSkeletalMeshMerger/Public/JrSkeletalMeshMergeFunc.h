...
// #include "JrSkeletalMeshMergeFunc.generated.h"
...
public:
	...
	/**
	 * Constructs a FJrRefPoseOverride.
	 */
	FJrRefPoseOverride(const USkeletalMesh* ReferenceMesh)
	{
...
private:
	...
	friend class FJrSkeletalMeshMerge;
};

/** 
* Utility for merging a list of skeletal meshes into a single mesh.
*/
class JRSKELETALMESHMERGER_API FJrSkeletalMeshMerge
{
public:
	/**
	* Constructor
	...
	*/
	...
	PRAGMA_DISABLE_DEPRECATION_WARNINGS
	FJrSkeletalMeshMerge(const FJrSkeletalMeshMerge&) = default;
	PRAGMA_ENABLE_DEPRECATION_WARNINGS
	 ...
	 */
	bool DoMerge(TArray<FJrRefPoseOverride>* RefPoseOverrides = nullptr);
	 ...
	 * @param RefPoseOverrides - An optional override for the merged skeleton's reference pose.
	 */
	void MergeSkeleton(const TArray<FJrRefPoseOverride>* RefPoseOverrides = nullptr);
...
private:
	...
	*/
	 ...
	 */
	static void OverrideReferenceSkeletonPose(const TArray<FJrRefPoseOverride>& PoseOverrides, FReferenceSkeleton& TargetSkeleton, const USkeleton* SkeletonAsset);
	...
	//void OverrideSockets(const TArray<FJrRefPoseOverride>& PoseOverrides);
	 ...
	 */
	void OverrideMergedSockets(const TArray<FJrRefPoseOverride>& PoseOverrides);
